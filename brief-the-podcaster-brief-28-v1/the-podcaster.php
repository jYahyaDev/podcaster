...
<body><pre><?php
  ...
  try {
    ...
    $prepare->execute(array(
      ":podcast_name" => "L'affaire Jose (1/4) : l'inconnu de la Contrescarpe",
    ...
    $prepare->execute(array(
      ":podcast_id"=> 4,
      ":podcast_description" => "Dans \"Affaires pas sensibles\", une plongée au cœur de l’une des plus grandes intrigues de l’histoire religieuse : l’énigme de l’Arche d’alliance.\n\nUne affaire qui n'est pas sans rappeler le personnage d'Indiana Jones 🤠"
    ));
